...
print qq /
    ...
    /;
     ...
     if (system("smbclient -L ///$winipc") == 0) {
	print "success!\n";
	}
	else {
	print "[~] Command failed\n";
     ...
     if (system("echo "enumdomusers" | rpcclient -U "" -N $wineni") == 0) {
	print "success!\n";
...
#--------------------------------------------------------------#
sub Wingfivnetbios {
     if (system("nmap --script smb-vuln* -p 139,445 $wfn") == 0) {
	print "success!\n";
	}
	else {
	print "[~] Command failed\n";
...
#--------------------------------------------------------------#
sub Winctonetbios {
     if (system("smbclient -L ///\$wtn -n 'justatest' ") == 0) {
	print "success!\n";
	}
	else {
	print "[~] Command failed\n";
	}
     if (system("smbclient -L ///\$wtn\\ipc\$ -U administrator -n 'justatest' ") == 0) {
	print "success!\n";
	}
	else {
	print "[~] Command failed\n";
